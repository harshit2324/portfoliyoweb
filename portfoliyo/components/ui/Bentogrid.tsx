...
export const BentoGridItem = ({
 ...
 const handlecopy = () => {
  navigator.clipboard.writeText('richhariyaharshit684@gmail.com')
  setcopied(true)
 }
  ...
  return (
    ...
    >
      ...
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        {id === 2 && <GlobeDemo />}
        {id === 3 && (
          <div className=" flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:right-2"> <div className="flex flex-col gap-3 lg:gap-3 lg:pt-10 "> 
